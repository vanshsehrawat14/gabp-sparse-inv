> **EDITORIAL NOTE (2026-07-30; the frozen branch record below is unchanged).**
> This 2026-06-30 aggregate read reused HOLDOUT seeds `1000-1029` after the
> matched-fit protocol's first aggregate read on 2026-06-29. It is not an
> independent confirmation and is excluded from Paper 1. The `H3_CONFIRMED`
> headline below is the historical verdict of that later branch, not the
> current project claim. See `CONFIRMATORY_RESULTS.md` for the controlling
> public record.
