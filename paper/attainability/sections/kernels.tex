...
\citep{rauch1965maximum}), the star, the
...
non-symmetric tree to the general filled-pattern lower--upper (LU)
(Erisman--Tinney) selected
...
tape-free analytic backward passes whose autograd graphs are constant-size
regardless of $n$; these analytic backward passes are first-order operators and are validated
...
Here GaBP abbreviates Gaussian belief propagation.
